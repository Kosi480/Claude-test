...
class DartGameGUI:
    ...
    def show_main_menu(self):
        ...
        games = [
            ...
            ("Cricket", "Nummern schließen", COLORS["accent2"],
             lambda: self._placeholder("Cricket")),
            ...
            ("Dart Bowling", "10 Frames Bowling mit Darts", COLORS["accent"],
             lambda: self._placeholder("Dart Bowling")),
            ("Penalty Shootout", "Elfmeter-Duell", COLORS["green"],
             lambda: self._placeholder("Penalty Shootout")),
            ("Dart Memory", "Finde die Paare", COLORS["accent2"],
             lambda: self._placeholder("Dart Memory")),
        ]
        ...
        tools = [
            ...
            ("Blackjack", "Dart-Kartenspiel (21)", COLORS["yellow"],
             lambda: self._placeholder("Blackjack")),
            ("Treasure Hunt", "Erkunde die Schatzkarte", COLORS["accent2"],
             lambda: self._placeholder("Treasure Hunt")),
            ("Dart Assassin", "Geheime Aufträge", COLORS["red"],
             lambda: self._placeholder("Dart Assassin")),
            ("Dart Puzzle", "Zahlenrätsel lösen", COLORS["green"],
